...
themes: ["nightlife", "refusal", "US", "2025"]
...
Companion to [*AFTER-PARTY*](/songs/after-party/) on the same chapter EP. Where the title track still had verses (capacity, shortcuts, bruises, the cigarette that wasn't), this one keeps only the pre-chorus rule and runs the chorus four times back to back.
