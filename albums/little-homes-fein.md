...
press:
  ...
  - outlet: "Early FEiN interview: us then (YouTube)"
    ...
    desc: "Little Homes–era snapshot: Walton and Woodward on camera before the LP landed."
  ...
  - outlet: "Music Connection: NMC Artist of the Week (Sep 2014)"
    url: "https://lukefwalton.com/songs/monay-grabba/"
    date: "2014-09-26"
    desc: "New Artist of the Week · 8.0 · #Grownupz + Monay Grabba · [screenshot](/evidence/fein-music-connection-artist-of-week-sep-2014.png)"
  - outlet: "Music Connection: Top 25 New Music Critiques (2014 year-end)"
    url: "https://lukefwalton.com/songs/monay-grabba/"
    date: "2015-01-11"
    desc: "FEiN Times Issue #1 · FEiN 8.0 · feintimes.com · [screenshot](/evidence/fein-music-connection-top-25-2014.png)"
  - outlet: "FEiN Facebook: Tiny Giant back door install (Feb 2015)"
    url: "https://lukefwalton.com/albums/little-homes-fein/"
    date: "2015-02-18"
    desc: "Luke Walton broke big toe in two places installing soundproofed back door at Tiny Giant Recording · [screenshot](/evidence/fein-tiny-giant-back-door-toe-xray.png)"
...
*Little Homes* is the full-length FEiN album: concept album, social satire, maximal arrangement brain, two lead voices, and theatrical pop-rock/funk.

**FEiN, the Los Angeles indie duo of Luke Walton and Brandon Woodward** (Luke Francis Walton on songwriter credits), pronounced “fine.” Project page: [FEiN](/music/fein/). [BMI](https://www.bmi.com/news/entry/indie_spotlight_fein) describes them as a SoCal alternative duo hatched at USC’s [Thornton School of Music](https://music.usc.edu/) Popular Music Performance program, then producing and engineering from **Tiny Giant Recording** in Westlake Village.
...
**FEiN Times** / early FEiN is band-as-newspaper art-pop shell (Issue #1: comics, horoscopes, games, handmade music); **Little Homes** is the concept album that grew out of the first LMU sessions (social satire, maximal arrangements, two-voice duo identity). The album's subjects: the grown-up performance, the household, the body, the gun, the wallet, the church screen, the lonely person outside the “little home.”

Press comparisons on record: Queen-like arrangement logic and an early MGMT vibe (Glamglare); Pixies, Nile Rodgers, and St. Vincent as named influences, with an early Depeche Mode register on “Girl You Can’t Hide It” (BMI).

An [early FEiN interview on YouTube](https://www.youtube.com/watch?v=IMbCaso2O3w), **us then**: Walton and Woodward in the Thornton and Tiny Giant years, before *Little Homes*.
