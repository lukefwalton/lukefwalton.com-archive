---
title: "To Be like Water, Take a Nap"

description: "If you want to learn a new instrument, you should start napping. In this pod, I talk about mind-body connection, forming new synapses, and how musicians and pro athletes are actually very similar. Stop brute forcing your way to music greatness, and sleep your way to success!"
...
listenUrl: "https://podcasters.spotify.com/pod/show/lovemusicmore/episodes/To-Be-like-Water--Take-a-Nap-e3nfvcd"
spotifyUrl: "https://open.spotify.com/episode/7jOcxGNnAhW7S4Os2ZcOvv"
appleUrl: "https://podcasts.apple.com/us/podcast/to-be-like-water-take-a-nap/id1567355195?i=1000784003606&uo=4"
...
selectedMoments:
  - label: "Musicians and athletes, not just travel"
    startSec: 86
    note: "I set the parallel: professional musicians and athletes share the body-learning, not only the hotels."
  - label: "Next week: TOMMASO on drum mechanics"
    startSec: 101
  ...
  - label: "The secret is taking naps"
    startSec: 493
  ...
  - label: "Wu Wei: be like water"
    startSec: 723
    note: "I close the craft argument: brute force fights the groove; Wu Wei lets the water find it."

excerptQuotes:
  - text: "I really think that there's a lot of parallels between professional musicians and professional athletes."
    startSec: 84
    reviewed: true
  - text: "And my biggest secret, the thing that's helped me the most, is taking naps."
    startSec: 489
    reviewed: true
  - text: "The people that I know that take the most naps are NFL and NBA players."
    startSec: 527
    reviewed: true
  - text: "Those naps, I think LeBron takes like two or three naps a day, but those naps are the secret to the longevity."
    startSec: 542
    reviewed: true
  - text: "If you can practice, nap, practice, sleep, you're gonna wake up the next morning."
    startSec: 587
    reviewed: true
  - text: "There's this thing called Wu Wei, like be like water."
    startSec: 725
    reviewed: true
  - text: "I think that we're going to be talking with Tommaso and we'll pick up this conversation from the eyes of a drummer that's a lot better than I am."
    startSec: 757
    reviewed: true
